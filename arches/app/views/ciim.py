...
def search(request):
	...
	json_q = json.dumps({"query":{"bool":{"must":[{"match":{"reference_links":uuid}}],"must_not":[],"should":[]}},"from":(settings.SEARCH_ITEMS_PER_PAGE * (page - 1)),"size":settings.SEARCH_ITEMS_PER_PAGE,"sort":[],"aggs":{"type":{"terms":{"field":"type.base"}},"primaryFilter":{"terms":{"field":"type.sub_type"}}}}) 
	headers = {'Content-Type' : 'application/json'}
