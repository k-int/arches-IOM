...
def search(request):
	...
	json_q = json.dumps({"query":{"bool":{"must":[{"match":{"reference_link":uuid}},{"match":{"base.type":primaryFilter}}],"must_not":[],"should":[]}},"from":(settings.SEARCH_ITEMS_PER_PAGE * (page - 1)),"size":settings.SEARCH_ITEMS_PER_PAGE,"sort":[],"aggs":{"type":{"terms":{"field":"type.base"}}}}) 
	headers = {'Content-Type' : 'application/json'}
